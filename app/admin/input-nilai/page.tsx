...
export default function InputNilaiPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0b1635] text-blue-100 px-4 sm:px-8 py-10 space-y-12">

      {/* ================= FORM ================= */}
      <div className="bg-[#1a2f6d]/80 backdrop-blur-xl border border-cyan-400/15 rounded-2xl shadow-lg p-8 max-w-2xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <select
            ...
            className="w-full bg-[#0f1c3f] border border-cyan-400/20 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-400 text-blue-100"
          >
        ...
        <div className="mb-8 bg-linear-to-r from-cyan-500/10 to-purple-500/10 border border-cyan-400/20 p-5 rounded-xl">
      ...
      {/* ================= LIST DATA GRID ================= */}
      <div className="bg-[#1a2f6d]/80 backdrop-blur-xl border border-cyan-400/15 rounded-2xl shadow-lg p-8 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {Object.keys(groupedByTim).map((tim) => (
            <div
              key={tim}
              className="bg-[#0f1c3f] border border-cyan-400/15 rounded-xl p-6 flex flex-col"
            >
              <div className="mb-4 pb-3 border-b border-cyan-400/10">
                <h3 className="text-lg font-bold text-cyan-300 uppercase tracking-wider">
                  {tim}
                </h3>
                <p className="text-xs text-blue-400/60">
                  {groupedByTim[tim].length} Pegawai
                </p>
              </div>
              ...
              <div className="space-y-3">
                {groupedByTim[tim].map((item: any) => (
                  <div
                    key={item.id}
                    className="p-3 bg-[#132a5c] rounded-lg border border-cyan-400/10 flex flex-col gap-2"
                  >
                    ...
                    <button
                      ...
                      className="mt-2 text-xs px-3 py-1 rounded-md bg-linear-to-r from-purple-500 to-cyan-500 text-white hover:scale-105 transition self-start"
                    >
                      Edit
                    </button>
                  </div>
